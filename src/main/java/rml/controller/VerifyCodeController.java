...
public class VerifyCodeController {
    ...
    @ResponseBody
    public Object service(String sessionId, HttpServletResponse resp)
        ...
        VerifyCode code = verifyCodeService.checkSessionId(sessionId);
        if(code==null){
            returnJson.setErrorCode(7002);
            returnJson.setReturnMessage("sessionId不存在");
            returnJson.setServerStatus(0);
            return returnJson;
        }
        initxuan();
        ...
        code.setVerifyCode(randomCode.toString());
        verifyCodeService.updateVerifyCode(code);
    ...
    public Object service() {
        ...
        verifyCode.setUuid(UUID.randomUUID().toString());
