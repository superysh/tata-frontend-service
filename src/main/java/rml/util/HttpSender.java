...
public class HttpSender {
    ...
    public static String sendCode(String mobile,String code){
        String msg = "您好，欢迎使用咕咕饿了么，您的验证码为:"+code;
        return    send(mobile,msg);
    }



    public static String send(String mobile,String msg){
        String url = "http://222.73.117.158:80/msg/HttpBatchSendSM";
        String account = "susu8888";
        String pswd = "Aa123456";
        boolean needstatus = true;// 是否需要状态报告，需要true，不需要false
        String product = null;// 产品ID
        String extno = null;// 扩展码
        try {
         return   batchSend(url, account, pswd, mobile, msg, needstatus, product, extno);
        }catch (Exception ex){
            ex.printStackTrace();
        }
        return null;
